...
public:
	...
	//			}
	//			if (err == 0){
	//				give(arr, x, y, wide, length, index);//进行局部的赋值
	//				cout << "数组展示:" << endl;//数组展示
	//				print(arr);
	//			}
	//			else{
