...
template<typename Object, typename Weight>
int AMGraph<Object, Weight>::strgetIndex(char* str) const
{
	for (int i = 0; i<curSize; ++i)
	if (strcmp(vertexArray[i].index, str) == 0)
		return i;
...
template<typename Object, typename Weight>
int AMGraph<Object, Weight>::strgetIndex0(const char* str) const
{
	for (int i = 0; i<curSize; ++i)
	if (strcmp(vertexArray[i].index0.c_str(), str) == 0)
		return i;
...
//template<typename Object, typename Weight>
//inline int AMGraph<Object, Weight>::getIndex(const Road &x) const
//{
//	for (int i = 0; i<curSize; ++i)
//	if (vertexArray[i].index == x.index)
//		return i;
//
//	return -1;
//}
...
{
	for (int i = 0; i<curSize; ++i)
	if (strcmp(vertexArray[i].index0.c_str(), x.index0.c_str()) == 0)
		return i;
...
template<typename Object, typename Weight>
Road AMGraph<Object, Weight>::Print(int i)
{
	return vertexArray[i];
}
...
template<typename Object, typename Weight>
Weight AMGraph<Object, Weight>::getWeight(const Road &x1, const Road &x2) const
{
	int v1 = getIndex(x1),
		v2 = getIndex(x2);
...
*/
template<typename Object, typename Weight>
int AMGraph<Object, Weight>::getNextDst(const Road &x) const
{
	int i = getIndex(x);
...
template<typename Object, typename Weight>
int AMGraph<Object, Weight>::getNextDst(const Road &x1, const Road &x2) const
{
	int v1 = getIndex(x1),
		v2 = getIndex(x2);
...
template<typename Object, typename Weight>
void AMGraph<Object, Weight>::insertVertex(const Road &x)
{
	if (curSize < maxSize)
...
template<typename Object, typename Weight>
int AMGraph<Object, Weight>::GetIndex(const Road &x)
{
	for (int i = 0; i<curSize; ++i)
	if (vertexArray[i] == x)
		return i;
...
*/
template<typename Object, typename Weight>
void AMGraph<Object, Weight>::removeVertex(const Road &x)
{
	int v = getIndex(x);
...
*/
template<typename Object, typename Weight>
void AMGraph<Object, Weight>::insertEdge(const Road &x1, const Road &x2, Weight c)
{
	int v1 = getIndex(x1),
		v2 = getIndex(x2);

	if (v1 == -1)
		cerr << "There is no vertex: " << x1.index0.c_str() << endl;
	else if (v2 == -1)
		cerr << "There is no vertex: " << x2.index0.c_str() << endl;
	else
	if (v1 != v2)
	{
		edgeMatrix[v1][v2] = c;
...
*/
template<typename Object, typename Weight>
void AMGraph<Object, Weight>::removeEdge(const Road &x1, const Road &x2)
{
	int v1 = getIndex(x1),
		v2 = getIndex(x2);
